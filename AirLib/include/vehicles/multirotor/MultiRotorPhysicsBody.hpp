...
public:
	...
	virtual size_t extraWrenchCount() const
	{
		return wind_wrenchs_.size();
	}
	...
	virtual const Wrench& getExtraWrench(size_t index) const
	{
		return wind_wrenchs_.at(index);
	}
...
public:
	std::vector<Wrench> wind_wrenchs_;
