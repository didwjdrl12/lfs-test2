...
std::shared_ptr<MavLinkConnection>  MavLinkConnection::connectCPS(const std::string& nodeName, const std::string& localAddr, int localPort, const std::string& remoteAddr, int remotePort)
{
    return MavLinkConnectionImpl::connectCPS(nodeName, localAddr, localPort, remoteAddr, remotePort);
}
...
void MavLinkConnection::startListeningForCPS(const std::string& nodeName, std::shared_ptr<UdpClientPort> connectedPort)
{
    pImpl->startListeningForCPS(shared_from_this(), nodeName, connectedPort);
}
