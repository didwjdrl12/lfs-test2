...
namespace mavlinkcom_impl {
    ...
    public:
        ...
        static std::shared_ptr<MavLinkConnection>  connectCPS(const std::string& nodeName, const std::string& localAddr, int localPort, const std::string& remoteAddr, int remotePort);
        ...
        void startListeningForCPS(std::shared_ptr<MavLinkConnection> parent, const std::string& nodeName, std::shared_ptr<UdpClientPort>  connectedPort);
    ...
    private:
        ...
        static std::shared_ptr<MavLinkConnection> createConnectionForCPS(const std::string& nodeName, std::shared_ptr<UdpClientPort> port);
        ...
        void publishPackets();
        void readPackets();
        void readPacketsForCPS();
        void drainQueue();
        std::string name;
        std::shared_ptr<Port> port;
        std::shared_ptr<UdpClientPort> CPSport;
