...
public partial class JUtil : MonoBehaviour
    {
        ...
        #region [Process] 실행
        //------------------------------------------------------------------------------------------------------------------------------------------------------
        public static Process ExecuteProcess(string path, string program_name, bool check_duplicate_run = false, string arguments = "", ProcessWindowStyle window_style = ProcessWindowStyle.Normal) // ProcessWindowStyle.Hidden, Normal
        {
