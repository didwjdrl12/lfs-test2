...
namespace J2y.Network
{
    ...
    public partial class JNet
    {
        ...
        ////------------------------------------------------------------------------------------------------------------------------------------------------------
        //public static T Read<T>(BinaryReader recv_msg) where T : JNetData_base, new()
        //{
        //    var netdata = new T();
        ...
        ////------------------------------------------------------------------------------------------------------------------------------------------------------
        //public static void Write<T>(BinaryWriter writer, List<T> data) where T : JNetData_base
        //{
        ...
        //}
        ////------------------------------------------------------------------------------------------------------------------------------------------------------
        //public static void Read<T>(BinaryReader reader, List<T> buffer) where T : JNetData_base, new()
        //{
        //    buffer.Clear();
        ...
        ////------------------------------------------------------------------------------------------------------------------------------------------------------
        //public static void Write<T>(BinaryWriter writer, T[] data) where T : JNetData_base
        //{
        ...
        //}
        ////------------------------------------------------------------------------------------------------------------------------------------------------------
        //public static void Read<T>(BinaryReader reader, T[] buffer) where T : JNetData_base, new()
        //{
        //    int count = reader.ReadInt32();
