...
namespace J2y.Network
{
	...
	public sealed class NetQueue<T>
	{
        ...
        #region [Queue] Enqueue(IEnumerable)
        //------------------------------------------------------------------------------------------------------------------------------------------------------
        /// <summary>
        /// Adds an item last/tail of the queue
        /// </summary>
